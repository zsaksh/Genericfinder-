...
export const medicines: MedicineRecord[] = [
  {
    ...
    confidence: "Medium",
    commonMisspellings: ["liptor", "lippitor"],
    symptomCategories: ["cholesterol", "heart health"],
    interactionDataAvailable: false,
    estimatedFields: ["approximateCashPrice", "coverage hints"],
    unavailableFields: ["patient-specific interactions"],
  ...
  },
  {
    ...
    freshness: "Recently verified",
    confidence: "Medium",
    commonMisspellings: ["atorvastin", "atorvastatina"],
    symptomCategories: ["cholesterol", "heart health"],
    interactionDataAvailable: false,
    estimatedFields: ["approximateCashPrice"],
    unavailableFields: ["patient-specific interactions"],
  ...
  },
  {
    ...
    freshness: "Recently verified",
    confidence: "Medium",
    commonMisspellings: ["crestor generic", "rosuvastatin"],
    symptomCategories: ["cholesterol", "heart health"],
    interactionDataAvailable: false,
    estimatedFields: ["approximateCashPrice"],
    unavailableFields: ["patient-specific interactions"],
  ...
  },
  {
    ...
    confidence: "Medium",
    commonMisspellings: ["zocore", "simvastatin"],
    symptomCategories: ["cholesterol", "heart health"],
    interactionDataAvailable: false,
    estimatedFields: ["approximateCashPrice"],
    unavailableFields: ["patient-specific interactions"],
...
export const plans: InsurancePlan[] = [
  {
    ...
    serviceArea: "Demo counties in selected ACA markets",
    metalLevel: "Silver",
    qualityRating: 4,
    estimatedAnnualDrugCost: 76,
  ...
  },
  {
    ...
    serviceArea: "Demo metro HMO service areas",
    metalLevel: "Gold",
    qualityRating: 4,
    estimatedAnnualDrugCost: 52,
